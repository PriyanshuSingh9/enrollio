...
export default function CreateInternship() {
    ...
    async function handleSubmit(formData) {
        ...
        try {
            ...
            if (result.success) {
                // Redirect to the internship details page or list
                // Use a generic internships page if specific details page isn't ready
                router.push(`/admin`);
            } else {
                alert(result.error || "Failed to create internship. Please try again.");
                setIsLoading(false);
            }
        } catch (error) {
            console.error(error);
                    ...
                    <div className="p-6 md:p-12 pb-32 overflow-y-auto">
                        <div className="max-w-xl mx-auto space-y-10">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <textarea
                                            name="requiredSkills"
                                            rows="3"
                                            placeholder="Required Skills (e.g. React, Python, Communication)"
                                            className="w-full bg-transparent text-lg text-white placeholder-white/20 focus:outline-none resize-none"
                                        ></textarea>
                                    </div>
                                </div>
                            ...
                            <div className="pt-8">
                                ...
                                >
                                    {isLoading ? "Creating Internship..." : "Create Internship"}
                                </button>
                            </div>
