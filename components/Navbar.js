      ...
      >
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link href="/sign-in" className="text-sm text-[var(--text-secondary)] hover:text-white transition-colors duration-200 px-3 py-1.5">
              Sign In
            </Link>
            <Link href="/sign-up" className="text-sm bg-white text-black px-4 py-1.5 rounded-full font-medium hover:bg-[var(--text-secondary)] transition-all duration-200">
              Get Started
            </Link>
          </div>
        ...
        <div className="fixed inset-0 z-40 bg-[var(--bg-primary)] pt-20 px-6 animate-fade-in md:hidden">
          <div className="flex flex-col gap-6">
            ...
            <div className="pt-6 border-t border-[var(--border-subtle)] flex flex-col gap-3">
              <Link href="/sign-in" className="text-base text-[var(--text-secondary)]">
                Sign In
              </Link>
              <Link href="/sign-up" className="text-base bg-white text-black px-6 py-3 rounded-full font-medium text-center">
                Get Started
              </Link>
            </div>
          </div>
